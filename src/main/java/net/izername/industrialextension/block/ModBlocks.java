package net.izername.industrialextension.block;
...
public class ModBlocks {
    ...
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(IndustrialExtension.MOD_ID);
